      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="space-y-3">
              {personalInfo.email ? (
                <a
                  ...
                  className="flex items-center gap-3 text-gray-400 hover:text-neural-cyan transition-colors text-sm"
                >
                  <Mail size={16} />
                  {personalInfo.email}
                </a>
            ...
            <div className="space-y-2">
              {["About", "Skills", "Experience", "Projects"].map((link) => (
                <a
                  ...
                  className="block text-gray-400 hover:text-neural-cyan transition-colors text-sm"
                >
                  {link}
                </a>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-neural-border/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-600 text-xs flex items-center gap-1.5 hover:text-neural-cyan transition-colors"
          >
